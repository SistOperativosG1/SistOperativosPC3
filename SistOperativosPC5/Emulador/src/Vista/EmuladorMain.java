...
public class EmuladorMain extends javax.swing.JFrame {
    ...
    public EmuladorMain() {
        ...
        jProgressBar32.setVisible(false);
        ProcesoES2.setVisible(false);
    }
    ...
    private void initComponents() {
        ...
        keylogger = new javax.swing.JTextArea();
        ...
        Velocidad.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Lento", "Normal", "Rápido", "Muy Rápido", " " }));
        ...
        keylogger.setColumns(20);
        keylogger.setRows(5);
        keylogger.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                keyloggerKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                keyloggerKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                keyloggerKeyTyped(evt);
            }
        });
        jScrollPane7.setViewportView(keylogger);
                        ...
                        .addGroup(PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(PanelLayout.createSequentialGroup()
                                ...
                                .addGroup(PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jProgressBar35, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(ProcesoES5, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(22, 22, 22)
                                .addGroup(PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jLabel46)
                                    .addGroup(PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void IngresarProcesoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IngresarProcesoActionPerformed
        ...
        Prio.setText("");
        PMB.setText("");
        keylogger.requestFocus();//pone el cursor en la casilla de BusrtTime
    ...
    private synchronized void reconocerKeylogger(){
        Toolkit kit = Toolkit.getDefaultToolkit();
        keylogger.addKeyListener(new KeyAdapter() {
    ...
    private void keyloggerKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_keyloggerKeyTyped
       reconocerKeylogger();
    }//GEN-LAST:event_keyloggerKeyTyped

    private void keyloggerKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_keyloggerKeyPressed
        reconocerKeylogger();
    }//GEN-LAST:event_keyloggerKeyPressed

    private void keyloggerKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_keyloggerKeyReleased
        reconocerKeylogger();
    }//GEN-LAST:event_keyloggerKeyReleased
    ...
    ArrayList<Proceso> ColaTotal = new ArrayList<>();
...
//                    if (key & modo) {
//                        System.out.println("interrupcion por Teclado");
//                        pcb.setEstado("Bloqueado");//***********************************************************
//                        ColaListos = admin.removerDeCola(ColaListos, pcb);
//                        exec = false;
//
...
///aqui
            ...
            if (process.size() < 1) {
                ...
                modelListo.setRowCount(0);
                clearTablaMemoria(modelMemoria);
                modelPCB.setRowCount(0);
                break;
    ...
    public void clearTablaMemoria(DefaultTableModel modelMemoria){
        for(int i=0;i<100;i++){
            TablaMemoria.setValueAt("LIBRE",i,1);
            TablaMemoria.setValueAt("-",i,2);
        }
    ...
    private javax.swing.JTextArea keylogger;
